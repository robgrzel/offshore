...
int init_resources() {
	program = create_program("/mnt/WSPACE/MEGASync-P/WORK/Proj/UTILS/OpenGL/OpenGL_tutorial/graph000.v.glsl",
	                         "/mnt/WSPACE/MEGASync-P/WORK/Proj/UTILS/OpenGL/OpenGL_tutorial/graph000.f.glsl");
	if (program == 0)
		return 0;
