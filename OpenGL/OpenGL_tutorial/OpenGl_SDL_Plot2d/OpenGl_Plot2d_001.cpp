...
int init_resources() {
	program = create_program(
			"/mnt/WSPACE/MEGASync-P/WORK/Proj/UTILS/OpenGL/OpenGL_tutorial/graph001.v.glsl",
	        "/mnt/WSPACE/MEGASync-P/WORK/Proj/UTILS/OpenGL/OpenGL_tutorial/graph001.f.glsl");
	if (program == 0)
		return 0;
