...
int FLTK_hello(int argc, char **argv) {
	const int numButtons = 4;
	int buttonWidth=100, buttonHeight = 30;
	int boxWidth = 20, boxHeight = 40;

	int boxCords[2] = {300, 100};
	int buttonCoords[2][numButtons];

	for (int i =0, j=0; i<numButtons; i++, j+=2){
		buttonCoords[0][i] = 20;
		buttonCoords[1][i] = boxHeight+boxCords[1]+buttonHeight*(1+j);
	}
	
	Fl_Window *window = new Fl_Window(340,380);
	Fl_Box *box = new Fl_Box(
			boxWidth,boxHeight,
			boxCords[0],boxCords[1],"Hello, World!");
	Fl_Button *button = new Fl_Button(
			buttonCoords[0][0],buttonCoords[1][0],
			buttonWidth, buttonHeight, "label");
	Fl_Light_Button *lbutton = new Fl_Light_Button(
			buttonCoords[0][1],buttonCoords[1][1],
			buttonWidth, buttonHeight);
	Fl_Round_Button *rbutton = new Fl_Round_Button(
			buttonCoords[0][2],buttonCoords[1][2],
			buttonWidth, buttonHeight, "label");
