#include "GLSimpleState3d.h"



GLSimpleState3d::GLSimpleState3d( ) :
		m_initialized( false ) {
	std::cout << "GLSimpleState3d::GLSimpleState3d( ) \n";
...
void GLSimpleState3d::init( void* data ) {
	std::cout << "GLSimpleState3d::init( void* data )\n";
...
void GLSimpleState3d::clear( ) {
	std::cout << "GLSimpleState3d::clear( )\n";

}

void GLSimpleState3d::update( void* data ) {
	std::cout << "GLSimpleState3d::update( void* data ) \n";

	m_camera.SetGLModelViewMatrix();
}

void GLSimpleState3d::render( ) {
	std::cout << "GLSimpleState3d::render(0)\n";
	...
	//draw_scal_axes( 100.0f );
	draw_vec_axes( 100.f );


	drawin_cube(50,50,50,90,90,90);

	drawin_object(draw_cube,-50,-50,-50,90,90,90);
	...
	DRAW2D.DrawLine(0,0,-300,0,0,300,5.f);

	//DRAW2D.DrawPoint(10,0,10,1);
...
bool GLSimpleState3d::initialized( ) {
	std::cout << "GLSimpleState3d::initialized( )\n";

	return m_initialized;
}

void GLSimpleState3d::lightOn( ) {
	std::cout << "GLSimpleState3d::lightOn( )\n";
...
void GLSimpleState3d::lightOff( ) {
	std::cout << "GLSimpleState3d::lightOff( )\n";

	glDisable( GL_LIGHTING );
}

bool GLSimpleState3d::event( UIEvent* event ) {
	std::cout << "GLSimpleState3d::event( UIEvent* event )\n";
	...
	switch ( event->type() ) {
		...
		case UIEvent::MOUSE_MOVE:
			...
			break;
		case UIEvent::MOUSE_UP: m_buttonPressed = false;
			break;
