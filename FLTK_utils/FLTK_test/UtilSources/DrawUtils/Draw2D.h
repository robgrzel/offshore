...
class ODraw2D {
	public:
		...
		void DrawLine( float x0, float y0, float z0, float x1, float y1, float z1, float width = 1.0f );

		void DrawPointXY( float x0, float y0, float z0, float size );
		void DrawPointXZ( float x0, float y0, float z0, float size );
		void DrawPointYZ( float x0, float y0, float z0, float size );

		void DrawPoint( float x0, float y0, float z0, float size );
